...
```shell
curl "https://api-hipaa.geocod.io/v1.7/geocode?q=1109+N+Highland+St%2c+Arlington+VA&fields=census&api_key=YOUR_API_KEY"
curl "https://api-hipaa.geocod.io/v1.7/reverse?q=38.886672,-77.094735&fields=census&api_key=YOUR_API_KEY"
```
...
**Field name: `riding`**
```shell
curl "https://api-hipaa.geocod.io/v1.7/geocode?q=1109+N+Highland+St%2c+Arlington+VA&fields=riding&api_key=YOUR_API_KEY"
...
**Field name: `statcan`**
```shell
curl "https://api-hipaa.geocod.io/v1.7/geocode?q=1109+N+Highland+St%2c+Arlington+VA&fields=statcan&api_key=YOUR_API_KEY"
